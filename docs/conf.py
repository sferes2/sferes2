...
project = 'Sferes_v2' # FIXME
copyright = u'2008-2018, UPMC / Inria' # FIXME
author = u'Jean-Baptiste Mouret and others' # FIXME
...
html_theme_options = {
    ...
    'breadcrumb_root': project[0].upper()+project[1:], # set a custom name to the breacumb root
